...
if(! defined('FILE_CACHE_SUFFIX') ) 		define ('FILE_CACHE_SUFFIX', '.wpthemesense.txt');		// What to put at the end of all files in the cache directory so we can identify them
...
class timthumb {
	...
	public function __construct(){
		...
		$cachePrefix = ($this->isURL ? 'wpthemesense_ext_' : 'timthumb_int_');
		if($this->isURL){
